...
class ComputerNetworksView extends StatefulWidget {
  const ComputerNetworksView({super.key});

  @override
  State<ComputerNetworksView> createState() => _ComputerNetworksViewState();
}

class _ComputerNetworksViewState extends State<ComputerNetworksView> {
  CollectionReference? cnRef;
  ...
  void initState() {
    ...
    super.initState();
    cnRef = firestore.collection('attendance').doc(uid).collection('cn');
    getTotal();
  }

  void getTotal() async {
    var totalSnapshot = await cnRef!.doc('total').get();
              ...
              children: [
                const ListTile(
                  ...
                  leading: CircleAvatar(
                      radius: 30,
                      backgroundImage: AssetImage('assets/images/cn.jpg')),
                  title: FittedBox(
                    child: Text(
                      'Computer Networks',
