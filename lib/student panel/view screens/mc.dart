...
class MobileComputingView extends StatefulWidget {
  const MobileComputingView({super.key});

  @override
  State<MobileComputingView> createState() => _MobileComputingViewState();
}

class _MobileComputingViewState extends State<MobileComputingView> {
  CollectionReference? mcRef;
  ...
  void initState() {
    ...
    super.initState();
    mcRef = firestore.collection('attendance').doc(uid).collection('mc');
    print(uid);
    getTotal();
  }

  void getTotal() async {
    var totalSnapshot = await mcRef!.doc('total').get();
                ...
                children: [
                  const ListTile(
                    ...
                    leading: CircleAvatar(
                        radius: 30,
                        backgroundImage: AssetImage('assets/images/mc.jpg')),
                    title: FittedBox(
                      child: Text(
                        'Mobile Computing',
