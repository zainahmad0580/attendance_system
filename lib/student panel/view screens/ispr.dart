...
class ISPRView extends StatefulWidget {
  const ISPRView({super.key});

  @override
  State<ISPRView> createState() => _ISPRViewState();
}

class _ISPRViewState extends State<ISPRView> {
  CollectionReference? isprRef;
  ...
  void initState() {
    ...
    super.initState();
    isprRef = firestore.collection('attendance').doc(uid).collection('ispr');
    getTotal();
  }

  void getTotal() async {
    var totalSnapshot = await isprRef!.doc('total').get();
              ...
              children: [
                const ListTile(
                  ...
                  leading: CircleAvatar(
                      radius: 30,
                      backgroundImage: AssetImage('assets/images/ispr.jpg')),
                  title: FittedBox(
                    child: Text(
                      'Presentation Skills',
