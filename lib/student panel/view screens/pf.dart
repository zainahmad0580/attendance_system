...
class PFView extends StatefulWidget {
  ...
  @override
  State<PFView> createState() => _PFViewState();
}

class _PFViewState extends State<PFView> {
  CollectionReference? pfRef;
  ...
  void initState() {
    ...
    super.initState();
    pfRef = firestore.collection('attendance').doc(uid).collection('pf');
    getTotal();
  }

  void getTotal() async {
    var totalSnapshot = await pfRef!.doc('total').get();
